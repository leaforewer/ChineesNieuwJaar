...
<div style=" background: linear-gradient(to right, #ff9900 0%, #ff6666 100%);">
    ...
    <!-- Carousel Voedsels -->
    <div id="carouselExampleDark" class="carousel carousel-dark slide col-8 offset-2" data-bs-ride="carousel">
    ...
    <!-- Begin van het accordion infomartie -->
